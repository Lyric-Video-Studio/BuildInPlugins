...
namespace KlingAiPlugin
{
    public class ConnectionSettings : IJsonOnDeserialized, IJsonOnSerialized, IJsonOnSerializing
    {
        ...
        [Description("Access key for video. Each video creation uses credits. Access token is found from https://console.klingai.com/console/access-control/accesskey-management " +
        ...
        [Description("Access secret for video. Each video creation uses credits. Access token is found from https://console.klingai.com/console/access-control/accesskey-management " +
            "This application is not resposible for possible usage of credits and will not in any way refund any used credits!!!")]
