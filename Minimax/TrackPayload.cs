...
namespace MinimaxPlugin
{
    public class TrackPayload : IPayloadPropertyVisibility, IJsonOnDeserialized
    {
        ...
        public string VideoModel { get => videoModel ?? Settings?.model ?? "MiniMax-H3"; set => videoModel = value; }
        ...
        public void OnDeserialized() => videoModel ??= Settings?.model ?? "MiniMax-H3";
        public bool ShouldPropertyBeVisible(string propertyName, object trackPayload, object itemPayload)
        {
            var model = (trackPayload as TrackPayload)?.VideoModel ?? "MiniMax-H3";
